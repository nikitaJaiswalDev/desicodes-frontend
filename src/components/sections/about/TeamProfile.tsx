                  ...
                  <div className="mt-8 space-y-4">
                    ...
                    <div className="bg-white/5 backdrop-blur-md rounded-xl p-5 border border-white/10 hover:border-blue-500/30 transition-colors">
                      <p className="text-sm font-semibold text-white/80 mb-3 flex items-center gap-2">
                        <span className="text-blue-400">📚</span> Research & Publications
                      </p>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs text-white font-medium leading-relaxed">ML-Based Prediction of Phycocyanin Purity</p>
                            <p className="text-[10px] text-white/50 mt-0.5 leading-relaxed">Presented at AI & ML International Conference hosted by Azerbaijan Technical University & 4 other Universities</p>
                          </div>
                        </div>
                        {/* Paper 2 */}
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs text-white font-medium leading-relaxed">Attention-based seq2seq NLP model to learn Sanskrit–Chinese phonological mappings from Tang-era Buddhist lexicons</p>
                            <p className="text-[10px] text-white/50 mt-0.5 leading-relaxed">Presented at International Regional NLP Conference hosted by Gauhati University & Assam Skill University</p>
                          </div>
                        </div>
                        {/* Paper 3 */}
                        <div className="flex items-start gap-3">
