    ...
    >
      ...
      <div className="lg:w-1/2 space-y-6 lg:space-y-8">
        ...
        <div className="flex items-center space-x-3 lg:space-x-4 group cursor-pointer">
          <span className="text-sm font-medium text-white tracking-wide group-hover:text-white/80 transition-colors">
            {ctaText}
          </span>
          <svg
            className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-white group-hover:text-white/80 group-hover:translate-x-1 transition-all duration-200"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
